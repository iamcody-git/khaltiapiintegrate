...
$uniqueUrl = "http://localhost/misproject/Main.php";
$uniqueProductName = "shoes";
$successRedirect = "/http://localhost/misproject/Payment.php"; // change this url , it will be the page user will be redirected after successful payment
...
<div class="khalticontainer">
    ...
    <form action="pay.php" method="post">
        ...
        <input type="number" class="number" minlength="10" maxlength="10" name="mobile" placeholder="9xxxxxxxxx">
